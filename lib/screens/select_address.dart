...
class SelectAddress extends StatefulWidget {
  ...
  String tot;
  int count;
   SelectAddress(String cartTotalString, int con, {Key key,this.owner_id}) : super(key: key){this.tot=cartTotalString;this.count=con;}

  @override
  State<SelectAddress> createState() => _SelectAddressState(tot,count);
}
...
int counter;
  ...
  _SelectAddressState(String tot, int count){this.total=tot;this.counter=count;}
  ...
  onPressProceed(context) async {
    ...
    Navigator.push(context, MaterialPageRoute(builder: (context) {
      return ShippingInfo(
          owner_id: widget.owner_id,tot:total, counters:counter);
    })).then((value) {
      onPopped(value);
    });
