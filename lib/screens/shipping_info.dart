...
class ShippingInfo extends StatefulWidget {
  ...
  ShippingInfo({Key key, this.owner_id,this.tot, this.counters}) : super(key: key);

  @override
  _ShippingInfoState createState() => _ShippingInfoState(tot,counters);
}
...
String tot;
int concon;
  _ShippingInfoState(String tot, int counters)
  {
    this.tot=tot;
    this.concon=counters;
  }
  ...
  onPressProceed(context) async {
    ...
    Navigator.push(context, MaterialPageRoute(builder: (context) {
      return Checkout(
        ...
        paymentFor: PaymentFor.Order,total:tot , conter :concon
      );
    })).then((value) {
      onPopped(value);
    });
